...
for (i in dum_n) {
  dum_vessels$c_name[i] <- paste("vessel ", i)
}
...
speak_generally(dum_vessels)

check_kde_list(dum_vessels)

assess_risk(dum_vessels)

give_context(dum_vessels, itf_foc)

detail_vessels(dum_vessels)
