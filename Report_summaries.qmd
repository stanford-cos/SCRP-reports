...
all_vessels <- read_csv(file.path(data_dir,"CompiledVesselsIndicators-2023-03-07.csv"))
...
speak_generally(analysis_df)

check_kde_list(analysis_df)

assess_risk(analysis_df)

give_context(analysis_df, itf_foc)

detail_vessels(analysis_df)
