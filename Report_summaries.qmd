...
all_vessels <- read_csv(file.path(data_dir,"CompiledVesselsIndicators-2023-03-20.csv"))
...
speak_generally(nesi_norway)

check_kde_list(nesi_norway)

assess_risk(nesi_norway)

give_context(nesi_norway, itf_foc)

detail_vessels(nesi_norway)
